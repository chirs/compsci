 ...
 *          11 Nov 09; 18 Nov 08; 08 Apr 09; 07 Nov 09
 */
...
public static void emitp(int voice, String note, int time, int d) {
    System.out.println("emitp: " + time + " " + instruments[voice] + " "
                       + voice + " " + note + " " + d);
    restto(voice, time);
    inststring[voice] += (note + durations[d]);
...
// empty buffers into a music string
    ...
    */
	...
	switch (action){
	    case "repeat": return 0; break;
	    case "seq": return 0; break;
	    case "sync": return 0; break;
	default:  return action.time();
	}
    }
 ...
 // if the queue is not empty, remove the next event and execute it
	...
	String command = first(act);
	/*
	if (command == "seq"){
	    Cons actions = rest(act);
	    }
	*/
	if (command == "sync"){
	...
	*/
	...
	PriorityQueue pqe = initpq((Cons) reader("(seq (piano 0 E5 1) (piano 0 A5 1) (piano 0 C6 1) (piano 0 B5 1) (piano 0 E5 1) (piano 0 B5 1) (piano 0 D6 1) (piano 0 C6 2) (piano 0 E6 2) (piano 0 G#5 2) (piano 0 E6 2) (piano 0 A5 1) (piano 0 E5 1) (piano 0 A5 1) (piano 0 C6 1) (piano 0 B5 1) (piano 0 E5 1) (
piano 0 B5 1) (piano 0 D6 1) (piano 0 C6 2) (piano 0 A5 2) (rest 2))"));
        simulator(pqe);
        String stre = mstring();
